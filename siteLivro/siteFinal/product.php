					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<?php
								if (empty($_SESSION)){
							?>			
								<a href="indexLogin.php"    class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-addcart-detail">Logar</a>
							<?php
								}else{
							?>			
							...
							<a href="../pagamentoTeste/index.php?livro=<?php echo $row['cd_livro'];?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
								Comprar
							</a>
							<?php
								}
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									<?php  echo utf8_encode($row['nm_livro']); ?>
								</a>
